...
write_xaringan_theme(
  ...
  title_slide_background_image = "assets/logo_sensolution.id.png",
  title_slide_background_size = "450px",
  title_slide_background_position = "17% 35%",
...
**Model ANOVA:**
$$Y_{iks}=\mu+\alpha_i+\beta_k+\gamma_s+\alpha\beta_ik+\alpha\gamma_is+\beta\gamma_ks+\epsilon_{iks}$$

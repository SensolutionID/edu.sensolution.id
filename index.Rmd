...
Pada saat lokakarya akan digunakan aplikasi R dan SenseHub untuk menyelesaikan studi kasus. Oleh karena itu, sangat diharapkan Anda telah berhasil memasang R, RStudio, beserta paket-paket yang diperlukan sebelum lokakarya dilaksanakan. Selain itu, Anda juga akan diberikan akses untuk SenseHub Pro selama lokakarya berlangsung. Demi kepentingan itu, kami memerlukan data nama beserta email yang Anda miliki untuk kelancaran akses ke SenseHub Pro tersebut. Terakhir, silakan bawa laptop beserta *charger* demi kelancaran saat lokakarya berlangsung. Jangan ragu untuk mengubungi surel [info@sensolution.id](mailto:info@sensolution.id) jika Anda memiliki pertanyaan atau kendala. Salam hangat dan sampai jumpa!
